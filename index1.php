...
<body>
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"; style="float: none; display: inline-block;"><a href="index1.php">Segitiga (Sama Sisi)</a></li>
	...
	<div class="kalkulator">
		...
		<h2 class="judul">LUAS / KELILING SEGITIGA (SAMA SISI)</h2>
		<form method="post" action="index1.php">			
			<input type="text" name="bil1" class="bil" autocomplete="off" placeholder="Masukkan Panjang Sisi(CM)">
			<input type="text" name="bil2" class="bil" autocomplete="off" placeholder="Masukkan Tinggi(CM)">
