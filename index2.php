...
<body>
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"; style="float: none; display: inline-block;"><a href="index2.php">Linkaran</a></li>
	...
	<div class="kalkulator">
		...
		<h2 class="judul">LUAS / KELILING LINGKARAN</h2>
		<form method="post" action="index2.php">			
			<input type="text" name="bil1" class="bil" autocomplete="off" placeholder="Masukkan Panjang Diameter(CM)">
			<input type="text" name="bil2" class="bil" autocomplete="off" placeholder="Masukkan Panjang Jari-Jari(CM)">
